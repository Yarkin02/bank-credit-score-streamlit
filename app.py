...
# Logo ekleyin
logo_html = f'<img src="{add_logo("/Users/apple/Desktop/Bank-Credit-Score-Streamlit/credit_score.png", width=200, height=100)}" style="display:block; margin-left:auto; margin-right:auto; width:500px; height:250px;">'
...
if st.button('Predict'):
    ...
    st.success(f"Person's Credit Score: {original_prediction}")
